<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"./template/pc/rainbow/cart/index.html";i:1540260096;s:68:"/www/wwwroot/proyuewanji/template/pc/rainbow/public/sign-header.html";i:1540260096;s:63:"/www/wwwroot/proyuewanji/template/pc/rainbow/public/footer.html";i:1540260096;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<body>
<!--顶部广告-s-->
<?php $pid =1;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1566432000 and end_time > 1566432000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
								...
								<div  id="edge_<?php echo $cart_v['id']; ?>" data-type="<?php echo $cart_v['prom_type']; ?>" data-goods-id="<?php echo $cart_v['goods_id']; ?>" class="meal-conts-items">
									...
									<div class="item-single p">
										<div class="breadth_phase">
											...
											<div class="column t-goods">
												<p class="msp_spname">
													<a href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$cart_v[goods_id])); ?>"><?php echo $cart_v['goods_name']; ?></a>
										...
										<div class="column t-action">
											<p>
												<a href="javascript:void(0);" class="deleteGoods deleteItem" data-goodsid="<?php echo $cart_v['goods_id']; ?>" data-cart-id="<?php echo $cart_v['id']; ?>" data-cart-idd="<?php if($key==0): ?><?php echo $cart['id']; else: ?><?php echo $cart_v['id']; endif; ?>">
													删除</a>
											</p>
