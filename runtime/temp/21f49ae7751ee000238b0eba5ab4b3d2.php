<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view/user/tasklist.html";i:1563527095;s:66:"/www/wwwroot/proyuewanji/application/admin/view/public/layout.html";i:1540260090;}*/ ?>
<!doctype html>
<html>
<head>
...
<!--     <div class="mDiv">
    ...
    <div class="tDiv">
      <div class="tDiv2">
          <div class="fbutton"> 
        		<a href="<?php echo U('Admin/User/pubtask',array('type'=>1)); ?>"><div class="add" title="新增文章"><span><i class="fa fa-plus"></i>新增任务</span></div></a> 
          </div>
           <div class="fbutton"> 
        		<a href="<?php echo U('Admin/User/pubtask',array('type'=>2)); ?>"><div class="add" title="新增文章"><span><i class="fa fa-plus"></i>新增广告</span></div></a> 
          </div>
          ...
          <tbody>
            <?php if(is_array($tasklist) || $tasklist instanceof \think\Collection || $tasklist instanceof \think\Paginator): if( count($tasklist)==0 ) : echo "" ;else: foreach($tasklist as $k=>$vo): ?>
              <tr>
                ...
                <!-- <td align="left" class="">
                  <div style="text-align: left; width: 150px;"><?php echo $vo['conte']; ?></div>
                </td> -->
           <!--      <td align="center" class="">
                ...
                <td align="center" class="handle">
                  <div style="text-align: center; width: 170px; max-width:170px;"> <a class="btn blue" target="_blank" href="<?php echo U('Home/Article/detail',array('article_id'=>$vo['article_id'])); ?>"><i class="fa fa-search"></i>查看</a>
                    ...
                    <a href="<?php echo U('User/pubtask',array('act'=>'edit','id'=>$vo['id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a> 
                  </div>
                </td>
